...
<div class="passage me-lg-5 ms-lg-5 p-2 pt-3">
        ...
        <div class="container">
            ...
            <h3 class="text-center" id="formhead">Trash Seller Login</h3>
            <hr class="mb-3">
                <form action="seller_validation.php" method="post" style="margin-left:50px;">
                            <div class="form-group">
                                <label>User Name</label>
                                <input type="username" id="username" name="username" class="form-control" placeholder="Enter First Name">
                            </div>
                            <div class="form-group">
                            ...
                            <br>
                            <button type="submit" class="btn btn-primary" id="btn" name="submit">Login</button>
                            </div>
                       <div class="col-md-6 text-center">
                            <img src="../images/log.png" alt="" srcset="" class="aboutImg" style="width: 350px;height:450; margin-top:50px;" >
                        </div>      
                        </form>
                    </div>
                       <div class="col-md-6 text-center">
